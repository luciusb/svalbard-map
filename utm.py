...
# author - Han Ul Yoon
# downloaded at http://robotics.ai.uiuc.edu/~hyoon24/LatLongUTMconversion.py
...
if __name__ == '__main__':
  for i,l in enumerate(_ellipsoid[1:]):
    (z, e, n) = LLtoUTM(i, 15.6447, 78.2179,33)
    print "%-24s,%4s, %-8dE, %-8dN"%(l[1],z, e, n)
  (z, e, n) = LLtoUTM(22, 15.6447, 78.2179,33)
